...
1. my chat application retain history of conversations
2. all chat sessions should be available to read on leftsidebar even if I restart the application
3. When I go back to any chat history and start chatting it should retain the context and responses from model should be based on that
